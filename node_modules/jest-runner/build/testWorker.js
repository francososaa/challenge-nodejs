'use strict';
/* build-hook-start *//*00001*/try { require('c:\\users\\soosa\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.210\\out\\buildhook\\index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///c:/users/soosa/.vscode/extensions/wallabyjs.console-ninja-0.0.210/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
